...
public class information {
	...
	public information() {
		...
		Inf_GUI.setBounds(300,200,450,600);
		...
		User1.setBounds(20,60,400,30);
		Inf_panel.add(User1);
		JLabel User2 = new JLabel("Андриянов Максим Владимирович № зачетной книжки:19130344"); 
		User2.setBounds(20,100,400,30);
		Inf_panel.add(User2);
		JLabel User3 = new JLabel("Сайдуганов Руслан Анатольевич № зачетной книжки:19130636"); 
		User3.setBounds(20,140,400,30);
		Inf_panel.add(User3);
		JLabel User4 = new JLabel("Хуснуриялов Булат Фагитович № зачетной книжки:19130608"); 
		User4.setBounds(20,180,400,30);
		Inf_panel.add(User4);
		JLabel data = new JLabel("Данные из загруженного файла:");
		data.setBounds(20,220,200,30);
		Inf_panel.add(data);
